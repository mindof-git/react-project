      ...
      <body>  
           ...
           <div class="container" style="width:800px;">  
                ...
                <ul class="nav nav-tabs">  
                     ...
                     <!-- <li><a data-toggle="tab" name="priceplan" href="packtab.php">Packages <span ></a></li>  -->
                ...
                <div class="tab-content">  
                     ...
                     <div class="col-md-4" style="margin-top:12px;">  
                          <div style="border:0.5px solid #333; background-color:#f1f1f1; border-radius:5px; padding:16px; height:350px;" text-align="center">  
                               <img src="img/<?php echo $row["image"]; ?>" width="150px", height="50px" class="img-responsive" /><br />  
                          ...
                          <div class="table-responsive" id="order_table">  
                               <table class="table table-bordered">  
                                    ...
                                    <tr>  
                                         ...
                                         <td text-align="right">$ <?php echo $values["product_price"]; ?></td>  
                                         <td text-align="right">$ <?php echo number_format($values["product_quantity"] * $values["product_price"], 2); ?></td>  
